 ...
 */
final class Version20260219195232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE billet ADD COLUMN rendered_png_path VARCHAR(500) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__billet AS SELECT id, qr_code, type, prix, is_valide, is_utilise, date_utilisation, created_at, updated_at, transaction_id, statut_paiement, evenement_id, client_id, organisateur_id, valide_par_id FROM billet');
        $this->addSql('DROP TABLE billet');
        $this->addSql('CREATE TABLE billet (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, qr_code VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, prix NUMERIC(10, 2) NOT NULL, is_valide BOOLEAN NOT NULL, is_utilise BOOLEAN NOT NULL, date_utilisation DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, transaction_id VARCHAR(255) DEFAULT NULL, statut_paiement VARCHAR(50) NOT NULL, evenement_id INTEGER NOT NULL, client_id INTEGER NOT NULL, organisateur_id INTEGER DEFAULT NULL, valide_par_id INTEGER DEFAULT NULL, CONSTRAINT FK_1F034AF6FD02F13 FOREIGN KEY (evenement_id) REFERENCES evenement (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F034AF619EB6921 FOREIGN KEY (client_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_1F034AF6D936B2FA FOREIGN KEY (organisateur_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BILLET_VALIDE_PAR FOREIGN KEY (valide_par_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO billet (id, qr_code, type, prix, is_valide, is_utilise, date_utilisation, created_at, updated_at, transaction_id, statut_paiement, evenement_id, client_id, organisateur_id, valide_par_id) SELECT id, qr_code, type, prix, is_valide, is_utilise, date_utilisation, created_at, updated_at, transaction_id, statut_paiement, evenement_id, client_id, organisateur_id, valide_par_id FROM __temp__billet');
